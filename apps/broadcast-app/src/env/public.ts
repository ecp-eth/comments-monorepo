...
const publicEnvSchema = z.object({
  ...
  NEXT_PUBLIC_EFP_ACCOUNT_METADATA_ADDRESS: HexSchema,
  NEXT_PUBLIC_EFP_LIST_REGISTRY_ADDRESS: HexSchema,
  NEXT_PUBLIC_EFP_LIST_MINTER_ADDRESS: HexSchema,
  NEXT_PUBLIC_EFP_LIST_RECORDS_ADDRESS: HexSchema,
