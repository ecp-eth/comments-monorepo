...
export function initializeChannelEventsIndexing(ponder: typeof Ponder) {
  const channelCreatedHandler: (
    args: IndexingFunctionArgs<"CommentsV1ChannelManager:ChannelCreated">,
  ) => Promise<void> = async function channelCreatedHandler({
    event,
    context,
  }) {
  ...
  const channelUpdatedHandler: (
    args: IndexingFunctionArgs<"CommentsV1ChannelManager:ChannelUpdated">,
  ) => Promise<void> = async function channelUpdatedHandler({
    event,
    context,
  }) {
    await db.transaction(async (tx) => {
  ...
  const channelHookStatusUpdatedHandler: (
    args: IndexingFunctionArgs<"CommentsV1ChannelManager:HookStatusUpdated">,
  ) => Promise<void> = async function channelHookStatusUpdatedHandler({
    event,
    context,
  }) {
    await db.transaction(async (tx) => {
  ...
  const channelMetadataSetHandler: (
    args: IndexingFunctionArgs<"CommentsV1ChannelManager:ChannelMetadataSet">,
  ) => Promise<void> = async function channelMetadataSetHandler({
    event,
    context,
  }) {
    await db.transaction(async (tx) => {
  ...
  const channelTransferHandler: (
    args: IndexingFunctionArgs<"CommentsV1ChannelManager:Transfer">,
  ) => Promise<void> = async function channelTransferHandler({
    event,
    context,
  }) {
    await db.transaction(async (tx) => {
