...
`Comment Data` is a term used to describe the essential information of a comment, the data structure is referenced in many places within this project.

Here we will go through the properties of `Comment Data`, and have a detailed look at each property.
