...
For full examples, please refer to the [examples](https://github.com/ecp-eth/comments-monorepo/tree/main/examples/channels-and-hooks/typescript/retrieve-takes-channel-hook-post-fee.ts)
