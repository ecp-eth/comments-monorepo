---
title: Protocol Fees
description: Learn about ECP protocol fees.
---
...
1. Channel Creation Fee (default: 0 - free)

   - Channel creation is currently free
   - Can be adjusted by the protocol owner if needed in the future
...
3. Hook Transaction Fee (default: 2%)
   ...
   - This fee is used to support the protocol's development and maintenance
   - The remaining value is passed to the hook as the `hook fee`
...
Example of using the helper functions can be found in the [examples](https://github.com/ecp-eth/comments-monorepo/tree/main/examples/snippets/typescript/retrieve-estimatable-channel-hook-fee-via-sdk.ts)
