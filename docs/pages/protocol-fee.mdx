...
// Caveat: In real world situation please use one of the big decimal libraries to
// avoid precision loss when converting back and forth between big int and number

const totalFee = commentCreationFee + BigInt(Number(hookCommentFee) / (10000 - transactionHookFee) * 10000);
