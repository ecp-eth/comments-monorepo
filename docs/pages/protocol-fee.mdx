...
> ⚠️ Before you dive into the details, please note that we already implemented a helper function to calculate the total fee required for posting/editing a comment on a channel.
>
> You can find [the helpers here]:
> [estimateChannelPostCommentFee](https://comments-monorepo-docs-git-feat-estimatable-hook-discove.vercel.app/sdk-reference/channel-manager/functions/estimateChannelPostCommentFee) > [estimateChannelEditCommentFee](https://comments-monorepo-docs-git-feat-estimatable-hook-discove.vercel.app/sdk-reference/channel-manager/functions/estimateChannelEditCommentFee)
