...
description: Using the ECP TypeScript SDK for creating comments, managing channels, fetching data from the indexer, and handling signatures.
---
...
// @see https://github.com/ecp-eth/comments-monorepo/blob/main/examples/signer/README.md
//
