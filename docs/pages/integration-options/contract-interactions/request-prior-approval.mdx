...
1. somebody submits the approval data with the author's signature to blockchain

### Who pays for the gas?

It is up to you to choose who pays for the gas and make the transaction. However, if you do want to cover the gas for the users,
ensure there are measures in place to prevent somebody from draining the balance of the app signer. A few options are:
...
The demo app check the user approval on the `/api/approval` endpoint:
...
🧑‍💻 _[/apps/demo/src/app/api/approval/route.ts](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/app/api/approval/route.ts#L61-L94)_
...
🧑‍💻 _[/apps/demo/src/app/api/approval/route.ts](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/app/api/approval/route.ts#L112-L119)_
...
🧑‍💻 _[/apps/demo/src/app/api/approval/route.ts](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/app/api/approval/route.ts#L191-L202)_
