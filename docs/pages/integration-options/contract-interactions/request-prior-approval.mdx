...
- Use [`addApproval()`](/protocol-reference/CommentsV1#addapprovaladdress-author-address-appsigner-uint256-nonce-uint256-deadline-bytes-signature-external) method to approve an app with author signature.
- Use [`addApprovalAsAuthor()`](/protocol-reference/CommentsV1#addapprovalasauthoraddress-appsigner-external) method to approve an app provided that it was called by the author.
