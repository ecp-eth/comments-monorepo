...
In certain situations, you may want to offer a frictionless experience to your users where your app pays for the gas fees. This is useful for:
...
to illustrate the process of posting a comment with gas covered by the app server.

### The Contract

- For latest contract address, see [COMMENTS_V1_ADDRESS](/sdk-reference/defaultExports/variables/COMMENTS_V1_ADDRESS).
- We will call [`postComment()`](/protocol-reference/CommentsV1#postcommentstruct-commentsv1commentdata-commentdata-bytes-authorsignature-bytes-appsignature-external) method to post the comment.
...
- For request prior permission and approval, see [Request Prior Approval](/integration-options/contract-interactions/request-prior-approval).

Assuming the user has granted permission, the flow is straightforward:
...
1. Post the comment by calling `postComment()` method on the contract with the `appSignature`.
...
1. The author counter signs the comment data with their wallet
1. The author post back the signed comment data to app server
1. The app server submits and pays for the transaction

For dependencies and test environment setup, please refer to previous [examples in Contract Interactions](/integration-options/contract-interactions). For detailed explanation of the flow, see the [Post Comment Flows](/post-comment-flows#4-appending-comment-to-a-transaction-author-pays-gas).
...
🧑‍💻 _[/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx#L100-L110)_
...
🧑‍💻 _[/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx#L51-L60)_

Endpoint at `/api/sign-comment/gasless/prepare` will also submit the transaction if the app has been previously approved.
...
🧑‍💻 _[/apps/demo/src/app/api/sign-comment/gasless/prepare/route.ts](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/app/api/sign-comment/gasless/prepare/route.ts#L57-L63)_
...
🧑‍💻 _[/apps/demo/src/app/api/sign-comment/gasless/prepare/route.ts](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/app/api/sign-comment/gasless/prepare/route.ts#L65-L71)_
...
This is a necessary optimisation to avoid wasting gas on a transaction that will be reverted.
...
And fail early with an appropriate http error if not approved.

🧑‍💻 _[/apps/demo/src/app/api/sign-comment/gasless/prepare/route.ts](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/app/api/sign-comment/gasless/prepare/route.ts#L82-L87)_
...
_The 2nd parameter `0x` tells the contract that there is no author signature._
...
🧑‍💻 _[/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx#L183-L186)_
...
🧑‍💻 _[/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx#L122C1-L127C10)_
...
🧑‍💻 _[/apps/demo/src/app/api/sign-comment/gasless/prepare/route.ts](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/app/api/sign-comment/gasless/prepare/route.ts#L57C3-L70C67)_
...
🧑‍💻 _[/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx#L116C1-L116C69)_

The hook is a helper function that help you to repeat the pattern of `prepare typed data` → `sign typed data` → `submit transaction`.
...
🧑‍💻 _[/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/components/comments/gasless/CommentBoxGasless.tsx#L139-L151)_

#### App server submits the signed comment data

To avoid attackers try to utilize the endpoint to drain gas, you may want to double check that the app signature is valid before submitting the transaction:
...
🧑‍💻 _[/apps/demo/src/app/api/sign-comment/gasless/route.ts](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/app/api/sign-comment/gasless/route.ts#L42C1-L74C4)_
...
🧑‍💻 _[/apps/demo/src/app/api/sign-comment/gasless/route.ts](https://github.com/ecp-eth/comments-monorepo/blob/094bcde2bca079bd7451c6571f26c5687b2ad128/apps/demo/src/app/api/sign-comment/gasless/route.ts#L77-L95)_
