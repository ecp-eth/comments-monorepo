...
- Use [`postComment()`](/protocol-reference/CommentsV1#postcommentstruct-commentsv1commentdata-commentdata-bytes-authorsignature-bytes-appsignature-external) method to post the comment.
