...
**Caveat**: Always check if you can achieve the same result by using our [SDK](http://localhost:3004/sdk-reference) or [Indexer API](/integration-options#2-indexer-api),
...
- The author will post and pay for the gas see ["author pays gas"](/post-comment-flows#1-author-pays-gas), and eventually pay for the gas.
