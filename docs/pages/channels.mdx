---
title: ECP Channels
description: Learn about ECP channels - ERC721 NFTs that organize comments and enable custom commenting rules through hooks and ownership.
---
...
Channel creation is currently free. The protocol retains the ability to introduce a channel creation fee in the future if needed for spam prevention, which can be checked by calling `getChannelCreationFee` from the SDK.
...
For full code examples used in this guide, check out the [examples](https://github.com/ecp-eth/comments-monorepo/tree/main/examples/snippets).
...
- See the full example [here](https://github.com/ecp-eth/comments-monorepo/tree/main/examples/snippets/typescript/create-channel.ts).
...
- See the full example [here](https://github.com/ecp-eth/comments-monorepo/tree/main/examples/snippets/solidity/CreateChannel.s.sol).
...
- [Examples](https://github.com/ecp-eth/comments-monorepo/tree/main/examples/snippets)
