...
See [CommentManager](/contract#comment-manager-contract-details) for more details.
...
See [ChannelManager](/contract#channel-manager-contract-details) for more details.
