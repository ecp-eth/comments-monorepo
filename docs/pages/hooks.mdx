---
title: Hooks
description: Learn about ECP hooks - smart contracts that define rules for commenting on channels.
---
...
For detailed information about protocol fees, including hook fees, see the [Protocol Fees](/protocol-fee) page.
