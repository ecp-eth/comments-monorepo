...
Base is an Ethereum L2 that offers significantly lower gas costs compared to Ethereum mainnet. Here are estimated fees based on varies L2 gas price:
...
The user totally paid for `0.000000218753205117 ETH` for the transaction, and at the time of transaction, it was `0.000439 USD`.
