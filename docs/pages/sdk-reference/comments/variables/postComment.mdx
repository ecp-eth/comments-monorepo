...
# Variable: postComment()

```ts
const postComment: (...args) => Promise<WaitableWriteContractHelperResult<readonly [{
  inputs: readonly [{
...
Defined in: [packages/sdk/src/comments/comment.ts:89](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/comments/comment.ts#L89)
