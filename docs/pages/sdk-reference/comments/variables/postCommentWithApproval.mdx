...
# Variable: postCommentWithApproval()

```ts
const postCommentWithApproval: (...args) => Promise<WaitableWriteContractHelperResult<readonly [{
  inputs: readonly [{
...
Defined in: [packages/sdk/src/comments/comment.ts:161](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/comments/comment.ts#L161)
