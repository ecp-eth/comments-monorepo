...
[@ecp.eth/sdk](/sdk-reference/index.mdx) / [comments](/sdk-reference/comments/index.mdx) / deleteCommentWithSig

# Variable: deleteCommentWithSig()

```ts
const deleteCommentWithSig: (...args) => Promise<WaitableWriteContractHelperResult<readonly [{
  inputs: readonly [{
...
Defined in: [packages/sdk/src/comments/comment.ts:371](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/comments/comment.ts#L371)
