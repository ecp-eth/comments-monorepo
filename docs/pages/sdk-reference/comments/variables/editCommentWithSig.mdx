...
[@ecp.eth/sdk](/sdk-reference/index.mdx) / [comments](/sdk-reference/comments/index.mdx) / editCommentWithSig

# Variable: editCommentWithSig()

```ts
const editCommentWithSig: (...args) => Promise<WaitableWriteContractHelperResult<readonly [{
  inputs: readonly [{
...
Defined in: [packages/sdk/src/comments/comment.ts:1007](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/comments/comment.ts#L1007)
