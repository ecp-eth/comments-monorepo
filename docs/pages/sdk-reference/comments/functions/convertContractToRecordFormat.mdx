...
Defined in: [packages/sdk/src/comments/metadata.ts:349](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/comments/metadata.ts#L349)
...
Optional mapping of known keys to their original string and type. If not provided, the key in the record will be the hex hash of the key.
