...
[@ecp.eth/sdk](/sdk-reference/index.mdx) / [indexer](/sdk-reference/indexer/index.mdx) / IndexerAPICommentReactionSchemaType

# Type Alias: IndexerAPICommentReactionSchemaType

```ts
type IndexerAPICommentReactionSchemaType = {
  app: `0x${string}`;
  author: {
     address: `0x${string}`;
     ens?: {
