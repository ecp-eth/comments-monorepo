...
[@ecp.eth/sdk](/sdk-reference/index.mdx) / [indexer](/sdk-reference/indexer/index.mdx) / IndexerAPIListCommentRepliesSchemaType
...
Use IndexerAPIListCommentsSchema instead
