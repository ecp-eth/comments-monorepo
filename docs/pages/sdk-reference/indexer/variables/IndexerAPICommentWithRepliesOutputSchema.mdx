...
```ts
const IndexerAPICommentWithRepliesOutputSchema: ZodObject<{
  ...
  replies: ZodObject<{
     ...
     results: ZodArray<ZodLazy<ZodType<IndexerAPICommentWithRepliesOutputSchemaType, ZodTypeDef, IndexerAPICommentWithRepliesSchemaType>>, "many">;
   }, "strip", ZodTypeAny, {
     extra: {
        moderationEnabled: boolean;
        moderationKnownReactions: string[];
  ...
  viewerReactions: ZodRecord<ZodString, ZodArray<ZodObject<{
     ...
     moderationClassifierScore: ZodNumber;
     moderationStatus: ZodEnum<["approved", "rejected", "pending"]>;
     parentId: ZodNullable<ZodEffects<ZodString, `0x${(...)}`, `0x${(...)}`>>;
     path: ZodString;
...
Defined in: [packages/sdk/src/indexer/schemas.ts:513](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/indexer/schemas.ts#L513)
