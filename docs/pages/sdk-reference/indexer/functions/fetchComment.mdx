...
```ts
function fetchComment(options): Promise<IndexerAPICommentWithRepliesSchemaType>;
```
...
`Promise`\<[`IndexerAPICommentWithRepliesSchemaType`](/sdk-reference/indexer/type-aliases/IndexerAPICommentWithRepliesSchemaType.mdx)\>
