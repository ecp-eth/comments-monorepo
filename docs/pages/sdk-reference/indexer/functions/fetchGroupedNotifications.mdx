...
function fetchGroupedNotifications(options): Promise<{
  ...
  notifications: {
     cursor: string;
     groupedBy: {
        notificationType: "reaction" | "reply" | "mention" | "quote";
        parent: {
           comment: {
              app: `0x${string}`;
              author: {
...
Defined in: [packages/sdk/src/indexer/api.ts:1471](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/indexer/api.ts#L1471)
