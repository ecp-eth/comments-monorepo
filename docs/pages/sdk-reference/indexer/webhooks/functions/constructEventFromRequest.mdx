...
Defined in: [packages/sdk/src/indexer/webhooks/utils.ts:152](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/indexer/webhooks/utils.ts#L152)
