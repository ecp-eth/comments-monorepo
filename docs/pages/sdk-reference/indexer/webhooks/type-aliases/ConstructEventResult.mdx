...
Defined in: [packages/sdk/src/indexer/webhooks/utils.ts:37](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/indexer/webhooks/utils.ts#L37)
