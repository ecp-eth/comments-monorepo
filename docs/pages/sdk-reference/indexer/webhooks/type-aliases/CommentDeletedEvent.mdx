...
Defined in: [packages/sdk/src/indexer/webhooks/schemas/comment.ts:182](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/indexer/webhooks/schemas/comment.ts#L182)
