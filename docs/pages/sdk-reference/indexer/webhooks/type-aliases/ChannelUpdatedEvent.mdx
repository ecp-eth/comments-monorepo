...
Defined in: [packages/sdk/src/indexer/webhooks/schemas/channel.ts:118](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/indexer/webhooks/schemas/channel.ts#L118)
