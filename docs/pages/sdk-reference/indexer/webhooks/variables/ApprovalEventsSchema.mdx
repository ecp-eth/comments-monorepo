...
Defined in: [packages/sdk/src/indexer/webhooks/schemas/approval.ts:209](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/indexer/webhooks/schemas/approval.ts#L209)
