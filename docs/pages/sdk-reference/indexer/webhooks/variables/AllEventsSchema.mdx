...
Defined in: [packages/sdk/src/indexer/webhooks/schemas/all.ts:27](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/indexer/webhooks/schemas/all.ts#L27)
