...
Defined in: [packages/sdk/src/indexer/webhooks/schemas/shared.ts:85](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/indexer/webhooks/schemas/shared.ts#L85)
