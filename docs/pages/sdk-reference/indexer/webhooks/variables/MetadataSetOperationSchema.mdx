...
Defined in: [packages/sdk/src/indexer/webhooks/schemas/shared.ts:44](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/indexer/webhooks/schemas/shared.ts#L44)
