...
[@ecp.eth/sdk](/sdk-reference/index.mdx) / [react](/sdk-reference/react/index.mdx) / EmbedConfigSchemaInputType

# Type Alias: EmbedConfigSchemaInputType

> **EmbedConfigSchemaInputType**: `object`
...
> `optional` **chainId**: `1` \| `8453` \| `11155111` \| `31337` = `EmbedConfigSupportedChainIdsSchema`
...
> `optional` **empty-screen-title**: `object` = `EmbedConfigFontSizeSchema`
...
> `optional` **error-screen-title**: `object` = `EmbedConfigFontSizeSchema`
...
> `optional` **headline**: `object` = `EmbedConfigFontSizeSchema`
...
> `optional` **sm**: `object` = `EmbedConfigFontSizeSchema`
...
> `optional` **xs**: `object` = `EmbedConfigFontSizeSchema`
