...
Defined in: [packages/sdk/src/embed/schemas/index.ts:111](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/embed/schemas/index.ts#L111)
