...
> **EmbedConfigThemeSchemaType**: `object`

Defined in: [packages/sdk/src/schemas/embed.ts:147](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/schemas/embed.ts#L147)
...
#### colors.dark.destructive-foreground?
...
#### colors.dark.secondary-foreground?
...
#### colors.light.account-edit-link?
...
#### colors.light.destructive-foreground?
...
#### colors.light.primary-foreground?
...
#### colors.light.secondary-foreground?
...
#### font.sizes.empty-screen-title?

> `optional` **empty-screen-title**: `object` = `EmbedConfigFontSizeSchema`

#### font.sizes.empty-screen-title.lineHeight?

> `optional` **lineHeight**: `string`

#### font.sizes.empty-screen-title.size?

> `optional` **size**: `string`

#### font.sizes.error-screen-title?

> `optional` **error-screen-title**: `object` = `EmbedConfigFontSizeSchema`

#### font.sizes.error-screen-title.lineHeight?

> `optional` **lineHeight**: `string`

#### font.sizes.error-screen-title.size?
...
#### font.sizes.headline.lineHeight?

> `optional` **lineHeight**: `string`

#### font.sizes.headline.size?
...
#### other.root-padding-horizontal?

> `optional` **root-padding-horizontal**: `string`

#### other.root-padding-vertical?
