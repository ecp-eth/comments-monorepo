...
[@ecp.eth/sdk](/sdk-reference/index.mdx) / [schemas](/sdk-reference/schemas/index.mdx) / EmbedConfigSchemaType

# Type Alias: EmbedConfigSchemaType

> **EmbedConfigSchemaType**: `object`

Defined in: [packages/sdk/src/schemas.ts:195](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/schemas.ts#L195)
