...
Defined in: [packages/sdk/src/channel-manager/react/channel.ts:304](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/channel-manager/react/channel.ts#L304)
