...
```ts
const updateChannel: (...args) => Promise<WaitableWriteContractHelperResult<readonly [{
  inputs: readonly [{
...
Defined in: [packages/sdk/src/channel-manager/channel.ts:187](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/channel-manager/channel.ts#L187)
