...
Defined in: [packages/sdk/src/channel-manager/channel.ts:70](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/channel-manager/channel.ts#L70)
