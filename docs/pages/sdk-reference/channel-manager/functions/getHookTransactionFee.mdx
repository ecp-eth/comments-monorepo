...
Defined in: [packages/sdk/src/channel-manager/hook.ts:83](https://github.com/ecp-eth/comments-monorepo/blob/main/packages/sdk/src/channel-manager/hook.ts#L83)
