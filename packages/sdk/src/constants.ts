...
export const COMMENT_MANAGER_ADDRESS = (
  __DEV__
    ? "0x05b54f69E7765683382c853Eb02A113609D9db84"
    : "0x1B674efDEC2BaC86cA952CD79eC83F4334dA1c7b"
) as Hex;
...
export const CHANNEL_MANAGER_ADDRESS = (
  __DEV__
    ? "0x4832F37FD27C9FfF5Ec66b28a811aBa45d03320C"
    : "0x50197226D677608B84b6De979EE9b32069541088"
) as Hex;
